...
export default function App() {
  ...
  return (
    <Container  className="container-main" maxWidth="xs" sx={{ mt: 2 }}>
    <Typography variant="h3" component="h1" align="center" gutterBottom>
        App Clima
      </Typography>
      <Box sx={{ display: "grid", gap: 2 }} component="form" autoComplete="off" onSubmit={onSubmit}>
        <TextField  id="city" label="Ciudad" variant="outlined" size="small" required  value={city}  onChange={(e) => setCity(e.target.value)} error={error.error} helperText={error.message}/>
      ...
      {weather.city && (
        <Box  sx={{mt: 2,display: "grid",gap: 2,textAlign: "center",}}>
          ...
          <Typography variant="h3" component="h4">
            {new Date().toLocaleDateString('es-us', { weekday:"long", })}
          </Typography>
          <Typography variant="h6" component="h4">
           {weather.localtime}
          </Typography>
